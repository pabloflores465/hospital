...
<template>
  <div class="flex justify-center items-center bg-gray-100 min-h-screen bg-[url('public/patient.jpg')] bg-cover bg-center fade-in">
    <div class="bg-white shadow-md rounded-2xl p-6 w-full max-w-sm">
      ...
      <div class="flex flex-col gap-4">
        ...
        <div class="flex items-center">
            <svg class="pe-2" stroke="currentColor" fill="#7f7f7f" stroke-width="0" viewBox="0 0 24 24" height="35px" width="35px" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z"></path></svg>
          <input
            type="email"
            placeholder="Email"
