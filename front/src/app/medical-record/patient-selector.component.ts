      ...
      <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <div *ngIf="!isLoading && !errorMessage">
          ...
          >
            ...
            <p>
              No hay pacientes con registros médicos asignados a usted. Esto
              puede deberse a:
            </p>
            ...
            <p class="mt-4">
              Por favor, contacte al administrador si necesita ayuda.
            </p>
          </div>

          <div *ngIf="patients.length > 0">
            <p class="mb-4 text-green-600 font-medium">
              Mostrando {{ patients.length }} pacientes con registros médicos
            </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              >
                ...
                <p *ngIf="patient.identification" class="text-sm text-gray-500">
                  DPI: {{ patient.identification }}
                </p>
            ...
            <div
              *ngIf="filteredPatients.length === 0 && searchTerm"
              class="text-center py-8 text-gray-500"
            >
...
export class PatientSelectorComponent implements OnInit {
  ...
  async loadPatients(): Promise<void> {
    ...
    try {
      // Obtenemos los pacientes asignados al doctor logueado
      const observable =
        await this.medicalRecordService.getPatientsAssignedToDoctor(
      ...
      observable.subscribe({
        ...
        error: (error: any) => {
          ...
          this.errorMessage = `Error al obtener pacientes asignados: ${
      ...
      console.error('Error al obtener observable de pacientes:', error);
      this.errorMessage = `Error al obtener datos de pacientes: ${
